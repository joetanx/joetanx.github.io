# Joe Tan's GitHub Page

## Conjur Setup

|Topic|Link|
|---|---|
|Setup standalone Conjur Enterprise leader on Podman on RHEL 9|<https://github.com/joetanx/conjur-master/>|
...
|Setup single-node Kubernetes cluster (with RHEL, CRI-O and Flannel)|<https://github.com/joetanx/cri-o-kube/>|
|Setup MySQL database|<https://github.com/joetanx/mysql-world_db/>|
|Generate a self-signed certificate chain with openssl|<https://github.com/joetanx/self-signed-ca/>|
|My OSCP preparation|<https://github.com/joetanx/oscp/>|
